preload_maincategs = [{categId:'1747',hasChildren:'false',name:'Accesorios para Vehículos >'},{categId:'1071',hasChildren:'false',name:'Animales y Mascotas >'},{categId:'1039',hasChildren:'false',name:'Cámaras Digitales y Foto >'},{categId:'1051',hasChildren:'false',name:'Celulares y Teléfonos >'},{categId:'1798',hasChildren:'false',name:'Coleccionables y Hobbies >'},{categId:'1648',hasChildren:'false',name:'Computación >'},{categId:'1144',hasChildren:'false',name:'Consolas y Videojuegos >'},{categId:'1276',hasChildren:'false',name:'Deportes y Fitness >'},{categId:'5726',hasChildren:'false',name:'Electrodomésticos >'},{categId:'1000',hasChildren:'false',name:'Electrónica, Audio y Video >'},{categId:'1574',hasChildren:'false',name:'Hogar y Muebles >'},{categId:'1499',hasChildren:'false',name:'Industrias y Oficinas >'},{categId:'1182',hasChildren:'false',name:'Instrumentos Musicales >'},{categId:'1132',hasChildren:'false',name:'Juegos y Juguetes >'},{categId:'3025',hasChildren:'false',name:'Libros, Revistas y Comics >'},{categId:'1168',hasChildren:'false',name:'Música, Películas y Series >'},{categId:'3937',hasChildren:'false',name:'Relojes y Joyas >'},{categId:'1430',hasChildren:'false',name:'Ropa y Accesorios >'},{categId:'1246',hasChildren:'false',name:'Salud y Belleza >'},{categId:'1953',hasChildren:'false',name:'Otras categorías >'}];

subcategories=[
[1,1747,'Accesorios para Carros','6934','C','Audio para Carros','3381','C','Farolas, Stops e Iluminación','8657','N','GPS','8662','N','Llantas y Rines','8415','N','Otros','2232','H','Repuestos y Acc. para Motos','8475','N'],
...
[1,1648,'Accesorios para Portátiles','3377','C','Apple','1870','C','Cartuchos, Toner y Tintas','2141','C','CDs y DVDs Vírgenes','1670','C','Computadores y Servidores','1649','N','Discos Duros y Externos','1669','C','Fuentes, UPS y Estabilizadores','1718','K','Impresoras','1676','C','Memorias Portátiles USB','5027','C','Memorias RAM','1694','C','Monitores y Video Beams','1655','C','Otros','1912','H','Palms, Agendas y Accesorios','1651','C','Partes y Componentes de PC','1691','C','Periféricos y Accesorios de PC','1712','C','Portátiles','1652','C','Quemadores de DVDs y CDs','9849','K','Redes y Redes Inalámbricas','1700','C','Software','1723','C','Tarjetas de Video y Captura','1686','C'],
...
[1,1182,'Amplificadores','3011','C','Audio Profesional','8687','C','Bajos','3018','K','Baterías y Percusión','3004','C','Guitarras','2987','C','Otros','3014','K','Otros Instrumentos de Viento','8416','K','Partituras','3360','K','Saxofones','4611','K','Teclados','2997','C','Violines','3023','K'],
...
[2,3813,'Adaptadores de Audio','39209','K','Adaptadores USB Bluetooth','6933','K','Antenas','4161','K','Baterías','5068','C','Cables de datos','4922','C','Carcasas','4159','C','Cargadores','5069','C','Displays y LCD','48906','C','Estuches y Forros','5213','N','Flex','5217','C','Lápices Opticos','39109','K','Manos Libres','5072','C','Otros','5549','H','Parlantes','11860','C','Ring Tones y Utilidades','5988','N','SIM Cards','10983','H','Teclados','39046','C'],
...
[2,1058,'Accesorios y Repuestos','2910','K','Equipos','2907','K','Otros','2911','K'],


[2,10616,'Cabinas','68009','H','Otros','53603','H','Software Tarificador','68027','H','Tarificadores','53597','H'],


[2,1053,'Faxes','8473','K','Otros','2899','H','Teléfonos de Mesa','2896','H'],


[2,5237,'Otros','17663','K','Recarga de Crédito','17664','K','Routers y Gateways','17662','K','Teléfonos','9210','K'],


[2,2895,'General Electric','32086','C','Otras Marcas','32103','C','Panasonic','32091','C','Philips','68010','C','Vtech','40740','C'],
...
[2,3377,'Adaptadores y Baterías','7222','C','Bases','16555','H','Cables','16558','H','Discos Duros','3707','C','Maletines para Portátiles','7223','N','Memorias','3582','C','Otros','3584','H','Pantallas','5874','H','Tarjetas PCMCIA','7220','H','Teclados','4222','H'],
...
[2,1669,'Cajas Externas','7032','K','Discos Duros','1672','C','Otros','4972','H'],
...
[2,1691,'Boards','1692','N','Coolers y Ventiladores','9752','H','Fuentes','63861','K','Modems','1701','H','Otros','1699','K','Procesadores','1693','N','Tarjetas Controladoras','63859','K','Tarjetas de Sonido','4119','K'],


[2,1712,'Audífonos y Diademas','31377','K','Cables y Conectores','1715','C','Conversores y Adaptadores','6644','K','Escáners','9714','K','Joysticks','2048','K','Kits de Teclado y Mouse','6263','K','Mouses','1714','C','Otros','1717','H','Parlantes','3378','N','Teclados','1713','K','Webcams','1667','C'],
...
[2,1700,'Adaptadores USB Bluetooth','6952','K','Antenas','7642','K','Otros','1710','H','Routers Convencionales','1707','K','Routers Inalámbricos','5563','C','Switches','1708','N','Tarjetas de Red','1706','K','Tarjetas de Red Inalámbricas','5016','C','Telefonía IP','10335','N'],


[2,1723,'Aplicaciones Comerciales','1728','K','Diseño y Multimedia','1731','K','Herramientas de Productividad','1733','K','Idiomas','43637','K','Juegos','9856','K','Linux','1734','K','Otros','1739','K','Sistemas Operativos','1737','K'],


[2,1686,'Capturadoras','6932','K','Otros','1690','K','Tarjetas de Video','1658','C'],
...
[2,3011,'Otros','4453','K','Para Bajo','4452','K','Para Guitarra','4451','K'],
...
[3,5068,'Blackberry','58502','K','HTC','57802','K','LG','47826','K','Motorola','6929','K','Nokia','6947','K','Otras Marcas','6948','K','Samsung','8541','K','Sony Ericsson','6928','K'],


[3,4922,'LG','8588','K','Motorola','6301','K','Nokia','5305','K','Otras Marcas','6291','K','Samsung','6303','K','Sony Ericsson','6290','K'],


[3,4159,'Blackberry','4168','K','HTC','57803','K','iPhone','68049','K','LG','57804','K','Motorola','4169','C','Nokia','4170','C','Otras Marcas','4172','K','Palm Treo','68032','K','Samsung','4173','K','Sony Ericsson','9373','C'],
...
[3,48906,'HTC','57792','K','iPhone','68065','K','LG','57793','K','Motorola','53588','K','Nokia','53592','K','Otros','53590','K','Palm Treo','68064','K','Samsung','53589','K','Sony Ericsson','53593','K'],
...
[3,5217,'Motorola','12895','K','Nokia','12883','K','Otros','12888','K','Samsung','48011','K','Sony Ericsson','48012','K'],
...
[3,5988,'Motorola','8437','H','Nokia','8442','H','Otros','8423','H'],
...
[3,68010,'2.4 GHz','68011','K','5.8 GHz','68012','K','DECT 6.0','68014','K','Otras Frecuencias','68013','K'],
...
[3,7222,'Acer','54425','K','Compaq','63171','K','Dell','12933','K','Gateway','63148','K','HP','9398','K','IBM','12932','K','Otros','9435','K','Sony Vaio','12946','K','Toshiba','32322','K'],


[3,3707,'120 GB a 190 GB','36814','K','200 GB a 490 GB','38736','K','500 GB o más','38936','K','Hasta 100 GB','36880','K'],
...
[3,3308,'Baterias','10321','K','Cables','5606','K','Carcasas','57928','K','Cargadores','9757','K','Estuches y Protectores','4136','K','Lápices','11898','K','Otros','4137','K','Teclados','5005','K'],


[3,9722,'7290','55262','K','8100','46206','K','8120','66784','K','8220','55241','K','8310','47850','K','8320','63853','K','8900','68018','K','9000 / Bold','46203','K','Otros Modelos','13461','K','Storm','58506','K'],
...
[3,1693,'AMD Athlon','9785','H','AMD Athlon X2','40463','H','AMD Phenom','44380','H','Intel Celeron','9794','H','Intel Core 2 Duo','10390','H','Intel Pentium 4','9745','H','Intel Pentium III','3625','H','Otros','3155','H'],


[3,1715,'Cables de Red','54154','K','Dvi','54426','K','FireWire','36856','K','Hdmi','32207','H','Otros','7621','H','PS/2','17962','H','RCA','63862','K','Serial ATA','9443','H','USB','5877','H','VGA','36844','H'],
...
[3,1667,'Con Micrófono','11145','K','Sin Micrófono','11109','K'],
...
[3,3302,'Baterías','57927','K','Cables','6494','K','Carcasas','57926','K','Cargadores','7031','K','Estuches y Protectores','8656','K','Lápices','11905','K','Otros','4146','K','Teclados','4882','K'],
...
[3,11889,'Epson','15040','K','Optoma Technology','15038','K','Otros','15042','K','Panasonic','15039','K','Sony','15041','K','Toshiba','59299','K'],
...
[3,8425,'Baquetas','29161','K','Otros','45430','K','Pedales','45431','K','Platillos','8451','K'],


[3,7086,'Afinadores','8421','K','Otros Accesorios','8440','K','Pedaleras','8436','K'],


[3,4275,'Fender','8445','K','Ibanez','8446','K','Jackson','8438','K','Otras Marcas','8420','K','Washburn','12990','K'],
...
[4,4170,'6131','68045','K','N73','68056','K','N95','68061','K','Otros','68057','K'],


[4,9373,'Otros','68060','K','W300','68058','K','W910','68059','K'],
...
[4,31672,'Acrílico','57805','H','Cuero','57806','H','Otros Materiales','57787','H','Películas Protectoras','57975','H','Silicona','57788','H'],


[4,67993,'Acrílico','67998','H','Cuero','67999','H','Otros Materiales','68000','H','Películas Protectoras','68002','H','Silicona','68001','H'],


[4,48009,'Acrílico','48975','H','Cuero','48976','H','Otros Materiales','48977','H','Películas Protectoras','57982','H','Silicona','48978','H'],


[4,57789,'Acrílico','57790','H','Cuero','57791','H','Otros Materiales','57794','H','Películas Protectoras','57977','H','Silicona','57795','H'],


[4,7889,'Acrílico','48911','H','Cuero','48914','H','Otros Materiales','48910','H','Películas Protectoras','57978','H','Silicona','48909','H'],


[4,7905,'Acrílico','48962','H','Cuero','48963','H','Otros Materiales','48964','H','Películas Protectoras','57979','H','Silicona','48965','H'],


[4,7888,'Acrílico','48966','H','Cuero','48968','H','Otros Materiales','48969','H','Películas Protectoras','57980','H','Silicona','48970','H'],


[4,38535,'Acrílico','58284','H','Cuero','58285','H','Otros Materiales','58288','H','Películas Protectoras','68066','H','Silicona','58289','H'],


[4,31671,'Acrílico','57807','H','Cuero','57808','H','Otros Materiales','57809','H','Películas Protectoras','57976','H','Silicona','57810','H'],


[4,10156,'Acrílico','48971','H','Cuero','48972','H','Otros Materiales','48973','H','Películas Protectoras','57981','H','Silicona','48974','H'],
...
[4,5604,'17\"','10992','K','19\" o más','18444','K','Hasta 15\"','10990','K'],


[4,4695,'17\"','6931','K','19\" o más','8862','K','Hasta 15\"','6964','K'],


[4,11901,'Epson','14731','K','Optoma Technology','14728','K','Otros','14733','K','Panasonic','14730','K','Sony','14732','K','Toshiba','59296','K'],
